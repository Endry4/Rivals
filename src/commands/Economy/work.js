...
const WORK_COOLDOWN = botConfig.economy?.cooldowns?.work ?? 0 * 10 * 1000;
const MIN_WORK_AMOUNT = botConfig.economy?.workMin ?? 1000;
const MAX_WORK_AMOUNT = botConfig.economy?.workMax ?? 10000;
